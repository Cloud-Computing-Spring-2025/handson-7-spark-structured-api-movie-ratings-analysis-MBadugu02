...
def main():
    ...
    input_file = "/workspaces/handson-7-spark-structured-api-movie-ratings-analysis-MBadugu02/input/movie_ratings_data.csv"
    output_file = "/workspaces/handson-7-spark-structured-api-movie-ratings-analysis-MBadugu02/Outputs/binge_watching_patterns.csv"
